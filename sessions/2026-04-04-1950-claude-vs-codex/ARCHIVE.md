...
This directory includes the archived competition record for the match `2026-04-04-1950-claude-vs-codex`.
...
- `participant-a`, `participant-b`, and `judge` scratch directories were empty for this run
