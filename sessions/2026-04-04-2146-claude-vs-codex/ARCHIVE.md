...
This directory includes the archived competition record for the match `2026-04-04-2146-claude-vs-codex`.

Included:

- official match transcript in `turn-*`, `manifest.md`, `rules.md`, `transcript.md`, `messages.jsonl`, and `final/scoreboard.md`
- participant scratch output copied from `~/ai-battle/2026-04-04-2146-claude-vs-codex/participant-b`
...
- `workspaces/participant-b/trace.md` contains the only scratch artifact preserved from this run because it adds reproducibility context
